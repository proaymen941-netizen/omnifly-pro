...
function defaultSettings() {
  return { paperWidth: 80, leftMargin: 8, rightMargin: 4, topMargin: 2, bottomMargin: 2, fontSize: 11, lineSpacing: 2, charactersPerLine: 48, mainPrinterName: null };
}
...
router.put("/printer-settings", (req, res) => {
  ...
  `).run(
    b.paperWidth ?? 80, b.leftMargin ?? 8, b.rightMargin ?? 4,
    b.topMargin ?? 2, b.bottomMargin ?? 2,
    b.fontSize ?? 11, b.lineSpacing ?? 2, b.charactersPerLine ?? 48,
